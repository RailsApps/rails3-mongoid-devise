...
This tutorial is based on Rails 3, Mongoid 2 beta 15, and Devise 1.1.1.
...
You'll need two gems in the *Gemfile*, like this:
...
You'll need to add this yourself when using Mongoid (now supported in Mongoid 2.0.0.beta.14 and newer).
