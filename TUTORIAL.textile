...
If you wish to "change the recipe" to generate the app with your own customized options, you can download the app and edit the file *template.rb*.

h2. Assumptions

This tutorial is based on Rails 3 beta 4, Mongoid 2 beta 7, and Devise 1.1.rc2.
...
If you intend to deploy to "Heroku":http://heroku.com/, note that Heroku supports Ruby version 1.8.7 but not Ruby version 1.9.2 (as of 18 June 2010).
...
The heroku gem is optional; include it if you intend to deploy to Heroku.
...
In this example, we'll use the default Rails template engine. Optionally, you can use another template engine, such as Haml. If you wish to do so, you can set it up like this:
...
To see your application in action, open a browser window and navigate to "http://admin.localhost:3000/":http://localhost:3000. You should see the Rails default information page.
...
In Mongoid 2 beta 7, "attr_accessible" is not yet implemented. Watch for a new release of Mongoid to implement this feature.
...
To see your application in action, open a browser window and navigate to "http://admin.localhost:3000/":http://localhost:3000. You should see your new home page.
