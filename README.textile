...
If you wish to "change the recipe" to generate the app with your own customized options, you can copy and edit the file *rails3-mongoid-devise-template.rb* found at the project "fortuity/rails3-application-templates":https://github.com/fortuity/rails3-application-templates.
