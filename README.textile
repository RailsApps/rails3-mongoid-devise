...
h4. Plataformatec's Simple Devise Example
...
h4. Fernando Tapia Rico's "rails3-mongoid-devise-omniauth"

Fernando Tapia Rico has extended the app at "fertapric/rails3-mongoid-devise-omniauth":https://github.com/fertapric/rails3-mongoid-devise-omniauth with

* "OmniAuth":https://github.com/intridea/omniauth (for authentication via OpenID, Facebook, OAuth, etc.)

and provides a detailed tutorial.

h4. Andi Altendorfer's "CBA"

Andi Altendorfer has extended the app at "iboard/CBA":http://github.com/iboard/CBA with
