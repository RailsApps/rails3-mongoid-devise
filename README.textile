...
The tutorial documents each step to follow to create the application. Every step is documented concisely, so a complete beginner can create this application without any additional knowledge. However, no explanation is offered for any of the steps, so if you are a beginner, you’re advised to look for an introduction to Rails elsewhere. See a list of "Rails books and online introductions":http://railsapps.github.com/rails-books.html for recommended reading.
...
If you are able to build the app with a newer gem, please create an "issue":http://github.com/railsapps/rails3-mongoid-devise/issues on GitHub and I will update the app.
