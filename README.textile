...
"View the Tutorial":http://wiki.github.com/fortuity/rails3-mongoid-devise/tutorial-walkthrough
...
This app is based on Rails 3, Mongoid 2 beta 15, and Devise 1.1.1.
...
If you intend to deploy to "Heroku":http://heroku.com/, note that Heroku supports Ruby version 1.8.7 but not Ruby version 1.9.2 (as of 31 July 2010).
...
This creates a new Rails app (with the @app_name@ you provide) on your computer. It includes everything in the example app (as described in the "tutorial":http://wiki.github.com/fortuity/rails3-mongoid-devise/tutorial-walkthrough). Plus it offers you the option of setting up your view files using the Haml templating language.
...
Note that Heroku supports Ruby version 1.8.7 but not Ruby version 1.9.2 (as of 31 July 2010). If you've developed the app locally using Ruby version 1.9.2, you may wish to use Ruby Version Manager (rvm) to switch to Ruby version 1.8.7 and test the app before deploying to Heroku.
...
See the "Tutorial":http://wiki.github.com/fortuity/rails3-mongoid-devise/tutorial-walkthrough for this app for details of how it was built. Please create an "Issue":http://github.com/fortuity/rails3-mongoid-devise/issues on GitHub if you identify any problems or have suggestions for improvements.
