...
The application uses the default Rails template engine (erb files). You may wish to use an alternative template engine such as Haml.
...
This app is based on Rails version 3 beta 4, Mongoid 2 beta 7, and the GitHub master version of Devise (current as of 17 June 2010).
...
This application provides no useful functionality apart from demonstrating Devise and Mongoid working together on Raisl 3.
